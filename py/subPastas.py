...
def executar_arquivo_bat(caminho_bat, caminho_diretorio):
    try:
        ...
        print(f"Arquivo .bat '{caminho_bat}' executado com sucesso no diretório '{caminho_diretorio}'.")
...
caminho_arquivo_bat = r'C:\Users\mairon.costa\OneDrive - Expertise Inteligência e Pesquisa de Mercado\expertise_mairon\2024\Audio_Cortes\Rayner\2024.08.26\Script.bat'
